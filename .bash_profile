...
PATH=$PATH:$HOME/bin:${JAVA_HOME}/bin:$HOME/nsq-0.3.6.linux-amd64.go1.5.1/bin:$HOME/maveninstall/apache-maven-3.3.9/bin:$GOPATH/bin:/$HOME/bin/Sencha/Cmd/6.0.2.14/..:/opt/gdal2/bin
